...
def cat(screen, x, y, k, color):
  ...
  for i in [[x + k*40, y - k*23], [x + k*100, y - k*23]]:
      ellipse(screen, color, (i[0], i[1], k*28, k*15))
      ellipse(screen, (0, 0, 0), (i[0], i[1], k*28, k*15), 1)

  #eyes

  for i in [[x + k*19, y - k*40], [x + k*41, y - k*40]]:
      circle(screen, (0, 255, 0), (i[0], i[1]), k*5)
      circle(screen, (0, 0, 0), (i[0], i[1]), k*5, 1)
      ellipse(screen, (0, 0, 0), (i[0] - k, i[1] - 5*k, k*2, k*10))
